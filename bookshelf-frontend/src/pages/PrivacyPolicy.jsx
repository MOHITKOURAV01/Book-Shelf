        ...
        <div className="privacy-content__inner">
          ...
          <nav className="privacy-toc">
            ...
            <ol className="privacy-toc__list">
              ...
              <li>
                <a href="#info-share">Information Sharing</a>
              </li>
              <li>
          ...
          <div className="privacy-sections">
            <section className="privacy-section" id="info-collect">
              ...
              <ul>
                ...
                <li>
                  <strong>Order Details:</strong> Shipping address, billing
                  information, and purchase history when you buy books.
                </li>
                <li>
                  <strong>Profile Data:</strong> Reading preferences, wishlists,
                  and reviews you choose to share.
                </li>
                <li>
            ...
            <section className="privacy-section" id="info-use">
              ...
              <div className="privacy-callout">
                ...
                <p>
                  <strong>Our promise:</strong> We never use your reading habits
                  or purchase history to build behavioural profiles for
                  advertising. Your reading life is private.
                </p>
              </div>
            </section>
            ...
            <section className="privacy-section" id="info-share">
              ...
              <ul>
                <li>
                  ...
                  transactions (e.g., Stripe, Razorpay).
                </li>
                <li>
                  <strong>Shipping Partners:</strong> To deliver your orders to
                  the correct address.
                </li>
                <li>
            ...
            <section className="privacy-section" id="cookies">
              ...
              <p>
                ...
                analytics scripts, or advertising pixels.
              </p>
            </section>
            ...
            <section className="privacy-section" id="data-security">
              ...
              <ul>
                <li>
                  All data transmitted to and from BookShelf is encrypted via
                  TLS/SSL.
                </li>
                <li>
                ...
                <li>
                  Payment data is handled entirely by PCI-DSS compliant
                  processors — we never store card numbers.
                </li>
                <li>
            ...
            <section className="privacy-section" id="data-retention">
              ...
              <ul>
                ...
                <li>
                  <strong>Order history:</strong> 5 years for tax and legal
                  compliance.
                </li>
                <li>
                  <strong>Support tickets:</strong> 2 years after resolution.
                </li>
                <li>
                  <strong>Technical logs:</strong> 90 days, then automatically
                  purged.
                </li>
              </ul>
            </section>
            ...
            <section className="privacy-section" id="children">
              ...
              <p>
                BookShelf is not intended for children under 13. We do not
                knowingly collect personal information from children. If you
                believe a child has provided us data, please contact us and we
            ...
            <section className="privacy-section" id="contact">
              ...
              <div className="privacy-contact-card">
                <div className="privacy-contact-card__row">
                  ...
                  <a href="mailto:privacy@bookshelf.com">
                    privacy@bookshelf.com
                  </a>
                </div>
                <div className="privacy-contact-card__row">
                  <svg
